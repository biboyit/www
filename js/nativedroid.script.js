					...
					clock : {
						...
						language : {
							...
							vi : {
								...
								monthShort : ["Th 1","Th 2","Th 3","Th 4","Th 5","Th 6","Th7","Th8","Th9","Th 10","Th 11","Th 12"],
								monthLong : ["Tháng 1","Tháng 2","Tháng 3","Tháng 4","Tháng 5","Tháng 6","Tháng 7","Tháng 8","Tháng 9","Tháng 10","Tháng 11","Tháng 12"],
								order : function(day,dayStr,date,month,monthStr,year) {
									return dayStr+", "+date+" "+monthStr+" "+year;
								}
							}
					...
					icon : {
						...
						create : function() {
							...
							if(nativeDroid.plugins.homescreen.widget.icon.iconType == "text") {
								html = "<div class='nativeDroidIconWidget' data-nativedroid-icon-href=''><i class='"+nativeDroid.plugins.homescreen.widget.icon.iconClass+"'></i><span>"+nativeDroid.plugins.homescreen.widget.icon.iconTitle+"</span></div>";
							}
							if(html != "") {
